...
const List<Article> EDUCATION_ARTICLES = [
  Article(
    ...
    body: '''
โปรตีนเป็นสารอาหารสำคัญสำหรับการซ่อมแซมร่างกายและสร้างกล้ามเนื้อ โดยเฉพาะคนที่ออกกำลังกายสม่ำเสมอควรใส่ใจเรื่องนี้มากเป็นพิเศษ
...
''',
  ...
  Article(
    ...
    body: '''
การนอนคือช่วงเวลาที่ร่างกายฟื้นฟูตัวเอง หากพักผ่อนไม่พอ ฮอร์โมนความหิวจะเสียสมดุลและทำให้ควบคุมอาหารยากขึ้น
...
''',
  ...
  Article(
    ...
    body: '''
น้ำช่วยให้ระบบต่างๆ ทำงานได้ดีขึ้น ทั้งการย่อย การลำเลียงสารอาหาร และการควบคุมความอยากอาหาร
...
ถ้าต้องการคุมหุ่น ให้เริ่มจากจัดปริมาณและเวลาให้เหมาะสม มากกว่าตัดออกไปทั้งหมด
''',
  ),
  Article(
    id: 5,
...
''',
  ...
  Article(
    id: 7,
    title: 'เวทเทรนนิงกับคาร์ดิโอ เลือกอะไรดี',
    category: 'Fitness',
    imageUrl:
...
- วางแผนมื้อง่ายขึ้น
- ลดการกินจุกจิก
- ช่วยคุมพลังงานรวมต่อวันได้

แต่ถ้าช่วงกินยังหลุดหนัก ก็อาจไม่ช่วยเท่าที่หวัง ดังนั้นคุณภาพอาหารยังสำคัญเหมือนเดิม
''',
  ),
  Article(
    id: 9,
    title: 'วิตามินที่คนคุมอาหารควรรู้จัก',
    category: 'Health',
    imageUrl:
        'https://images.unsplash.com/photo-1584017911766-d451b3d0e843?w=500&q=80',
    body: '''
เมื่อกินน้อยลงหรือเลือกอาหารจำกัดมากเกินไป อาจเสี่ยงขาดสารอาหารบางตัวได้

สารอาหารที่ควรสังเกต
1. วิตามินดี
2. แมกนีเซียม
3. วิตามินบีรวม
4. โอเมกา 3

อย่างไรก็ตาม พื้นฐานที่ดีที่สุดยังเป็นอาหารจริงที่หลากหลาย ส่วนอาหารเสริมควรใช้เมื่อจำเป็น
''',
  ),
  Article(
    id: 10,
    title: 'Mindset ที่ช่วยให้ทำต่อได้จริง',
    category: 'Habit',
    imageUrl:
        'https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=500&q=80',
    body: '''
การดูแลสุขภาพไม่ใช่การแข่งขันระยะสั้น แต่คือการสร้างพฤติกรรมที่ทำต่อได้ในชีวิตจริง

แนวคิดที่ช่วยได้มาก
1. ทำเล็กแต่สม่ำเสมอ
2. พลาดได้ แล้วกลับมาใหม่เร็ว
3. โฟกัสที่สุขภาพ ไม่ใช่แค่ตัวเลขบนตาชั่ง

ถ้าระบบที่คุณใช้ทำให้รู้สึกกดดันเกินไป ลองปรับให้เบาลงแต่ทำได้ต่อเนื่อง จะไปได้ไกลกว่า
''',
  ),
];
